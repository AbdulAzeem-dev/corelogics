/* Case studies index — five featured cases as magazine-style covers */
  ...
  return (
    <main className="cases-page">
      <PageHeader
        ...
        lede="Five projects across education, food safety, media measurement, retail media, and personal AI. Different industries, different challenges — the same level of quality on every one. Names are used with client permission; screenshots are from the live products."
      />

      <section className="cases-stats on-accent">
        <div className="page cases-stats-grid">
          {[
            { v: 5, s: '', l: 'Featured projects, on this page' },
