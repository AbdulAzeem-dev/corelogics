...
const CASE_STUDIES = [
  {
    ...
    capabilities: [
      { t: 'Multi-modal content ingestion', d: 'Processes large volumes of PDFs, scanned documents, and images — extracting not just text but also figures, charts, and diagrams with their full contextual meaning.' },
      { t: 'Visual question understanding', d: 'Vision-language intelligence that comprehends questions containing diagrams, equations, and visual reasoning components — not just text recognition.' },
      { t: 'Structured knowledge engine', d: 'Transforms unstructured academic resources into a queryable, organized knowledge base spanning subjects, topics, and difficulty levels.' },
    ...
    techHighlights: [
      'Vision-language understanding for question + diagram comprehension',
      'Multi-modal retrieval over the institution\u2019s curriculum corpus',
      'Adaptive question generation grounded in past-paper style',
      'Per-student mastery modeling and schedule optimization',
    ],
...

  {
    ...
    capabilities: [
      ...
      { t: 'Slaughterer identity verification', d: 'Facial recognition matches the active slaughterer against authorized profiles for the working zone and shift.', group: 'Slaughter' },
      ...
      { t: 'Edge-optimized deployment', d: 'A fully optimized inference pipeline runs on low-power edge devices — Raspberry-Pi-class hardware — without dependency on continuous cloud connectivity.', group: 'Infrastructure' },
    ],
    architecture: {
    ...
    techHighlights: [
      'Edge-optimized vision pipelines on constrained hardware',
      'Multi-camera object identity persistence and tracking',
      'Audio event detection synchronized with vision events',
      'Tamper-evident audit trail for regulator review',
    ],
...

  {
    ...
    techHighlights: [
      'Long-horizon personal memory with privacy boundaries',
      'Goal-state modeling and milestone tracking',
      'Multi-modal speech ↔ text continuity',
      'Proactive nudge scheduling against personal calendars',
    ],
